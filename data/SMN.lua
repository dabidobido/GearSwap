	...
	["Ifrit"] = 
		{
			...
			["Rage3"] = { name = "Meteor Strike",		target = "stnpc", 		set = "MagicBPDmg", description = "Fire Nuke" },
...
function custom_aftercast(spell)
	if started_bp_rage == true or started_bp_ward == true then -- don't equip idle set if still going to do a BP
		return true
	end
end
