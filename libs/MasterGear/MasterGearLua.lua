...
function precast(spell)
	...
	elseif spell.action_type == 'Magic' then
		if sets["Precast_" .. spell.english] then equip(sets["Precast_" .. spell.english])
		elseif sets[modes[mode].name .. "Fastcast"] then equip(sets[modes[mode].name .. "Fastcast"])
...
function target_change(player_id, target_id)
	if player_id == player.id then
		on_target_change_for_th(target_id)
	end
end
